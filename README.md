...
- `function.py` - simple reusable functions and parameters
- `ifelse.py` - condition examples
- `input.py` - reading values from the user
- `loops.py` - loop practice
- `list.py` - list operations
- `filehandling.py` - basic file handling examples
- `Challenge.py` - practice challenge
